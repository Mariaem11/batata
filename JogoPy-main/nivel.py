...
class Nivel:
                ...
                for obj in tmx_map.get_layer_by_name("Dano"):
                    ...
                    if obj.name == "espinho":
                        ...
                        if direcao_movi == "y":
                                ...
                                self.espinho = Espinho((self.all_sprites, self.dano_sprites), pos_inicial,
                                                        pos_final, direcao_movi, vel, obj.width, obj.height)
    ...
    def dano(self):
            ...
            if self.jogador.hitbox_rect.colliderect(self.espinho) or self.jogador2.hitbox_rect.colliderect(
                    self.espinho):
                #self.hit = True
